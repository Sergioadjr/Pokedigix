...
public class TipoController {
    ...
    @GetMapping
    public Collection<TipoResponseDTO> buscarTodos( @RequestParam (required = false, name = "nome") String nome) {
    ...
    @DeleteMapping
    @Transactional
    public void deletarTipoPorNome(@RequestParam (required = true) String nome) {
